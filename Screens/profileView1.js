...
export default function ProfileViewOne({ navigation }) {
  return (
	<SafeAreaView>
                     ...
                     <View>
                        ...
                        <Text  style={styles.txt8}>Task Completed </Text>
                         ...
                         <View
                            ...
                            />
                    <View>                    
                     <TouchableOpacity onPress={() => navigation.navigate('profileView2')}>
                     ...
                     <View style={{ flexDirection:'row',justifyContent:"space-around", paddingTop:60,alignContent:"flex-start"}}>
                        ...
                        <View >
                        <TouchableOpacity onPress={() => navigation.navigate('taskDetails1')}>                       
