...
import { selectLeader, selectTaskFollowers, selectTaskLeader } from "../features/appSlice";
...
export default function AddNewTask({ navigation }) {
   ...
   const [range, setRange] = React.useState({ startDate: new Date(), endDate: new Date().setDate(new Date().getDate() + 1) });
