   ...
   return (
      <ScrollView>
         <SafeAreaView style={{ paddingTop: 50, elevation: 5 }}>
            ...
            <View>
               <Text style={{ paddingLeft: 40, color: "#9599b3", fontSize: 14, paddingTop: 10, width: "90%" }}>{task?.description}</Text>
            </View>
            ...
            <View>
               <Text style={{ paddingLeft: 40, color: "#352641", fontSize: 16, fontWeight: "bold", paddingTop: 20 }}>Task assigned to:</Text>
            </View>
